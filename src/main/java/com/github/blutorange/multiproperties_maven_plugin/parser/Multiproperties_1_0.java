...
import com.github.blutorange.multiproperties_maven_plugin.xsd.version_1_0.MultiProperties;

final class Multiproperties_1_0 implements IMultiproperties {
  private final MultiProperties root;

  public Multiproperties_1_0(MultiProperties root) {
    this.root = root;
  }
  ...
  public List<Item> getItems() {
    ...
    for (final var record : root.getRecords().getPropertyOrCommentOrEmpty()) {
      if (record instanceof MultiProperties.Records.Property) {
        ...
        final var mapped = new Property(name, disabled, null, valueMap, false);
        result.add(mapped);
      }
